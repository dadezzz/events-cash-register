...
FROM git.zarantonello.dev/projects/events-cash-register-ci:v2026.08.27.1 AS pruner
...
FROM git.zarantonello.dev/projects/events-cash-register-ci:v2026.08.27.1 AS builder
